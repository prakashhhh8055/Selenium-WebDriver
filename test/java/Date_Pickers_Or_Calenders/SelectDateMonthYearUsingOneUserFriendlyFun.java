...
public class SelectDateMonthYearUsingOneUserFriendlyFun {
	
	//Select Date,Month and year
		static void SelectDateMonthYear(WebDriver driver,String date,String month,String year)
		{
			while(true)
	        {
	...
	public static void main(String[] args) {
        ...
        SelectDateMonthYear(driver,"20","April","2026");
